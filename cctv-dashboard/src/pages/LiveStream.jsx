    ...
    return (
        <div className="livestream-container">
            ...
            <div className="ngrok-guide">
                ...
                <ol>
                    <li>Install <a href="https://ngrok.com/download" target="_blank" rel="noreferrer">ngrok</a></li>
                    <li>Run: <code>ngrok http http://192.168.x.x:8080</code></li>
                    <li>Copy the public URL (e.g., <code>https://abcd1234.ngrok.io</code>)</li>
                    <li>Append <code>/video</code> if needed (e.g., <code>https://abcd1234.ngrok.io/video</code>)</li>
                    <li>Paste above & click "Start Stream"</li>
                </ol>
            </div>
            ...
            {connected && userId && (
                <div className="stream-frame">
                    <h4>Live Feed:</h4>
                    <img
                        src={`${API_BASE}/stream/video-feed?user=${userId}&t=${Date.now()}`}
                        alt="Live Feed"
                        className="video-frame"
